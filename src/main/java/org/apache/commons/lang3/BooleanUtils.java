...
public class BooleanUtils {
    ...
    public static Boolean toBooleanObject(final String str) {
        ...
        switch (str.length()) {
            case 1:
                return handleLengthOne(str);
            case 2:
                return handleLengthTwo(str);
            case 3:
                return handleLengthThree(str);
            case 4:
                return handleLengthFour(str);
            case 5:
                return handleLengthFive(str);
            default:
                return null;
        }
    }

    private static Boolean handleLengthOne(String str) {
    ...
    private static Boolean handleLengthTwo(String str) {
        char ch0 = str.charAt(0);
    ...
    private static Boolean handleLengthThree(String str) {
        char ch0 = str.charAt(0);
        char ch1 = str.charAt(1);
    ...
    private static Boolean handleLengthFour(String str) {
        char ch0 = str.charAt(0);
        char ch1 = str.charAt(1);
        char ch2 = str.charAt(2);
    ...
    private static Boolean handleLengthFive(String str) {
        char ch0 = str.charAt(0);
        char ch1 = str.charAt(1);
        char ch2 = str.charAt(2);
        char ch3 = str.charAt(3);
